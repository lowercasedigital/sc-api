SC.initialize({
  client_id: 'c7932c45f4f2134cfaa9957663fee1ca',
  redirect_uri: 'http://radicaljams.com/super--secret/callback.html'
});
...
(function($) {
  ...
  var apiKey,
      ...
      updatePlayStatus = function(player, status) {
        if(status){
          ...
          $('.sc-player.playing').removeClass('playing');
        }
        $(player)
      ...
      onSkip = function(player) {
        ...
        if(!$nextItem.length){
          $nextItem = $player.nextAll('.sc-player:first').find('.sc-trackslist li.active');
        }
        $nextItem.click();
      },
  ...
  $.scPlayer.defaults = $.fn.scPlayer.defaults = {
    ...
    onDomReady  : function() {
      $('a.sc-player, div.sc-player, article.sc-player').scPlayer();
    },
    autoPlay: false,
